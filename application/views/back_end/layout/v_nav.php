  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-item">
        ...
        <a href="#" class="nav-link has-dropdown"><i class="far fa-check-square"></i> <span>Master</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link beep beep-sidebar" href="<?= base_url('master/tambah'); ?>">Tambah Data Master</a></li>
          <?php if ($user['role_id'] == 1) : ?>
            <li><a class="nav-link" href="<?= base_url('master'); ?>">Daftar Master</a></li>
          <?php endif; ?>
        </ul>
      </li>
      <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-plus"></i> <span>Value</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link beep beep-sidebar" href="<?= base_url('values/tambah'); ?>">Menambah Values</a></li>
          <li><a class="nav-link" href="<?= base_url('values'); ?>">Daftar Values</a></li>
        </ul>
      </li>
