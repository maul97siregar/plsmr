		...
		<section class="section">
			<div class="container mt-5">
				<div class="d-flex align-items-center justify-content-center">
					<lottie-player src="<?= base_url(); ?>vendor/back-end/assets/plugins/lottie/error404.json" background="transparent" speed="1" style="width: 200px; height: 200px;" loop autoplay class="dashboard-img"></lottie-player>
				</div>
