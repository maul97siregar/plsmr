  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">
        Di halaman ini Anda dapat membuat values baru
      </p>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="<?= base_url('values/tambah'); ?>" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="">
                    <textarea name="isi" id="berita" value="<?= set_value('isi'); ?>">Isi values</textarea>
                ...
                <div class="form-group">
                  <div class="col-sm-12 col-md-12 d-flex align-items-center justify-content-center">
                    <button type="submit" class="btn btn-primary ">Buat values</button>
                  </div>
                </div>
              </form>
            </div>
